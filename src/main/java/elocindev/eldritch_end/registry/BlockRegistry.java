...
public class BlockRegistry {
    ...
    public static Block PRIMORDIAL_PRESSURE_PLATE = new PressurePlateBlock(PressurePlateBlock.ActivationRule.EVERYTHING, FabricBlockSettings
        .copyOf(Blocks.OAK_PRESSURE_PLATE).sounds(BlockSoundGroup.WOOD), BlockSetType.OAK);
    ...
    public static final Block PRIMORDIAL_DOOR = new DoorBlock(FabricBlockSettings
        .copyOf(Blocks.OAK_DOOR).sounds(BlockSoundGroup.WOOD), BlockSetType.OAK);
    ...
    public static final Block PRIMORDIAL_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings
        .copyOf(Blocks.OAK_TRAPDOOR).sounds(BlockSoundGroup.WOOD), BlockSetType.OAK);

    public static final BlockItem PRIMORDIAL_TRAPDOOR_ITEM = new BlockItem(PRIMORDIAL_TRAPDOOR, new FabricItemSettings());

    // Todo: Change this to EldritchProperties.PRIMORDIAL_SIGN_TYPE
    public static final SignBlock PRIMORDIAL_SIGN = new SignBlock(FabricBlockSettings.copyOf(Blocks.OAK_SIGN).sounds(BlockSoundGroup.WOOD), WoodType.OAK);

    // Todo: Change this to EldritchProperties.PRIMORDIAL_SIGN_TYPE
    public static final WallSignBlock PRIMORDIAL_WALL_SIGN = new WallSignBlock(Settings.copy(PRIMORDIAL_SIGN), WoodType.OAK);
    ...
    public static final ButtonBlock PRIMORDIAL_BUTTON = new ButtonBlock(FabricBlockSettings.copyOf(Blocks.OAK_WOOD), BlockSetType.OAK, 30, true);
    ...
    public static final Block PRIMORDIAL_FENCE = new FenceBlock(FabricBlockSettings.copyOf(Blocks.OAK_FENCE).sounds(BlockSoundGroup.WOOD));
    public static final BlockItem PRIMORDIAL_FENCE_ITEM = new BlockItem(PRIMORDIAL_FENCE, new FabricItemSettings());

    // Todo: change to primordial wood
    public static final Block PRIMORDIAL_FENCE_GATE = new FenceGateBlock(FabricBlockSettings.copyOf(Blocks.OAK_FENCE_GATE).sounds(BlockSoundGroup.WOOD), WoodType.OAK);
    ...
    // Default etyr
    public static final Block ETYR_ORE = new ExperienceDroppingBlock(FabricBlockSettings.copyOf(Blocks.IRON_ORE));
    ...
    public static final Block ETYR_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    public static final BlockItem ETYR_TRAPDOOR_ITEM = new BlockItem(ETYR_TRAPDOOR, new FabricItemSettings());

    public static final Block ETYR_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.METAL));
    ...
    public static final Block DECADENT_ETYR_DOOR = new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    ...
    public static final Block DECADENT_ETYR_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    public static final BlockItem DECADENT_ETYR_TRAPDOOR_ITEM = new BlockItem(DECADENT_ETYR_TRAPDOOR, new FabricItemSettings());

    public static final Block DECADENT_ETYR_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.METAL));
    ...
    public static final Block PERTURBED_ETYR_DOOR = new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    ...
    public static final Block PERTURBED_ETYR_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    public static final BlockItem PERTURBED_ETYR_TRAPDOOR_ITEM = new BlockItem(PERTURBED_ETYR_TRAPDOOR, new FabricItemSettings());

    public static final Block PERTURBED_ETYR_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.METAL));
    ...
    public static final Block CORRUPTED_ETYR_DOOR = new DoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_DOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    ...
    public static final Block CORRUPTED_ETYR_TRAPDOOR = new TrapdoorBlock(FabricBlockSettings.copyOf(Blocks.IRON_TRAPDOOR).sounds(BlockSoundGroup.METAL), BlockSetType.IRON);
    public static final BlockItem CORRUPTED_ETYR_TRAPDOOR_ITEM = new BlockItem(CORRUPTED_ETYR_TRAPDOOR, new FabricItemSettings());

    public static final Block CORRUPTED_ETYR_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.METAL));
    ...
    public static final Block SPIRE_STONE = new Block(FabricBlockSettings.copyOf(Blocks.STONE).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block POLISHED_SPIRE_STONE_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block POLISHED_SPIRE_STONE_BRICK_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.STONE));
    ...
    public static final Block POLISHED_SPIRE_STONE_TILE_SLAB = new SlabBlock(FabricBlockSettings.copyOf(Blocks.STONE_SLAB).sounds(BlockSoundGroup.STONE));
    ...
    public static void registerFullBlock(String identifier, Block blockInstance, BlockItem itemInstance) {
        Registry.register(Registries.BLOCK, new Identifier(EldritchEnd.MODID, identifier), blockInstance);
        ItemRegistry.reg(itemInstance, identifier);
    }

    public static void registerSign(String sign_name, Block SIGN, Block WALL_SIGN) {
        Registry.register(Registries.BLOCK, new Identifier(EldritchEnd.MODID, sign_name+"_sign"), SIGN);
        Registry.register(Registries.BLOCK, new Identifier(EldritchEnd.MODID, sign_name+"_wall_sign"), WALL_SIGN);
        Registry.register(Registries.ITEM, new Identifier(EldritchEnd.MODID, sign_name+"_sign"), PRIMORDIAL_SIGN_ITEM);
    }
}
