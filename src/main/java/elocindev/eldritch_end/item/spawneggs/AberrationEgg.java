...
public class AberrationEgg extends SpawnEggItem {
    ...
    String[] TOOLTIP_NORMAL = {
        "",
        "\u00A7l\u2022 \u00A79Bite \u00A78(Basic Attack)",
        "\u00A77Bites the target and deals \u00A7c"+ (int)Configs.Entity.ABERRATION.ATTACK_DAMAGE_ATTRIBUTE + "\u00A77 + \u00A7925% \u00A77per \u00A7ncorruption stack\u00A77.",
        "\u00A77Applies \u00A79\u00A7nCorruption\u00A7r\u00A77 for "+Configs.Entity.ABERRATION.initital_corruption_duration_ticks/20+"s. Stacks don't reset its duration." ,
        "",
        "\u00A7l\u2022 \u00A79Shadow's Grasp \u00A78(Passive, 1s Cooldown)",
