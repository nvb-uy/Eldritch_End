...
public class AberrationEgg extends SpawnEggItem {
    ...
    String[] TOOLTIP_NORMAL = {
        ...
        "\u00A77Applies \u00A79\u00A7nCorruption\u00A7r\u00A77 for "+Configs.ENTITY_ABERRATION.initital_corruption_duration_ticks/20+"s. Stacks don't reset the time." ,
        "",
        "\u00A79Shadow's Grasp \u00A78(Passive)",
        "\u00A77Heals 10% of maximum health every second while walking on Abysmal Fronds."
    };
